...
logger = logging.getLogger("harborrag.runtime.tools.readers")
    ...
    async def call(
        ...
        *,
        ...
        try:
            ...
            response = await self.require_knowledge().get_document_context(
                DocumentContextRequest(
    ...
    async def call(
        ...
        *,
        ...
        try:
            ...
            response = await self.require_knowledge().resolve_graph_nodes(
