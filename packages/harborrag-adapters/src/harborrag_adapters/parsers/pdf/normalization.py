...
def content_from_any(  # noqa: C901
    value: Any,
    *,
    depth: int = 0,
...
class PDFNormalizer:
    """Normalize accepted PDF engine output and preserve attempt provenance."""
    ...
    def normalize(
        ...
        *,
        ...
        return ParseResult.from_parsed_document(
            document,
