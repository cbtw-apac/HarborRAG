...
from .docling_configuration import DoclingConfigurationMixin
from .file_access import materialized_pdf_path, raise_if_encrypted_pdf
...
class DoclingBackend(DoclingConfigurationMixin, PdfBackend):
