...
from harborrag_adapters.repositories.vector.qdrant import (
    repository as qdrant_repository_module,
)
...
def test_filesystem_object_store_plugin_builds_unconnected_backend(
    tmp_path: Path,
) -> None:
...
def test_s3_object_store_plugin_builds_unconnected_store(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
