...
using sensitive documents or engines that download models.
...
python packages/harborrag-adapters/tests/smoke/parsers/parse_file.py samples/data.xlsx
python packages/harborrag-adapters/tests/smoke/parsers/parse_file.py samples/report.pdf
```
...
```bash
python packages/harborrag-adapters/tests/smoke/parsers/parse_file.py \
