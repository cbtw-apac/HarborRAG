...
from harborrag_adapters.chunking.confluence.adf import AdfDocumentParser
from harborrag_adapters.chunking.confluence.errors import ConfluenceNormalizationError
from harborrag_adapters.chunking.confluence.macros import default_macro_handlers
from harborrag_adapters.chunking.confluence.markup import (
    ConfluenceMarkupParser,
    _TreeParser,
)
from harborrag_adapters.chunking.confluence.nodes import ConfluenceNode
...
def test_macro_registry_rejects_duplicate_aliases_and_exposes_known_capabilities():
    ...
    assert "page-properties" in registry.supported_keys
