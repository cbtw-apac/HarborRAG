...
def _success(properties: dict[str, object], required: list[str]) -> dict[str, object]:
...
FETCH_EVIDENCE_SPEC = McpToolSpec(
    "fetch_evidence",
...
GET_DOCUMENT_CONTEXT_SPEC = McpToolSpec(
...
RESOLVE_GRAPH_NODES_SPEC = McpToolSpec(
    "resolve_graph_nodes",
