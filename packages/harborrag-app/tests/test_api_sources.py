"""Read-side source endpoints over the development app service."""
...
def test_list_sources_empty_in_development_mode() -> None:
    """Development composition has no persisted sources yet."""
...
def test_list_sources_filters_by_project_and_hides_secrets() -> None:
    ...
    # Simulate a pre-validation legacy row. New domain construction rejects this,
    # while the read DTO must still redact it if such data is encountered.
    legacy_source.config["token"] = "hunter2"
