...
currently exposes a Temporal-backed CLI, a small HTTP control-plane surface,
and an in-process MCP transport, while the adapter packages provide the broader
...
- [MCP Tools](detailed-guides/mcp-server/README.md) — in-process tool listing and calls.
...
The document/retrieval HTTP routes and external MCP transport remain incomplete.
