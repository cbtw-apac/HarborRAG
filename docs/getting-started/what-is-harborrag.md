...
| MCP | Audited, policy-bounded FastMCP transport exposing nine read-only evidence, source, and graph tools over stdio or bearer-authenticated loopback HTTP with a local status/configuration UI |
